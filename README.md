# KubeView
<img src="https://github.com/pstark-code/kubeview/raw/main/web/client/src/assets/logo.png" style="float:right">
...
### Status 
[![](https://img.shields.io/github/workflow/status/pstark-code/kubeview/Build%20Dockerhub%20Image?style=for-the-badge&logo=github)](https://github.com/pstark-code/kubeview/actions?query=workflow%3A%22Build+Dockerhub+Image%22)
[![](https://img.shields.io/github/last-commit/pstark-code/kubeview?style=for-the-badge&logo=github)](https://github.com/pstark-code/kubeview/commits/main)
[![](https://img.shields.io/github/v/release/pstark-code/kubeview?style=for-the-badge&logo=github)](https://github.com/pstark-code/kubeview/releases)
...
# Docker Image
Builds of the Docker image are hosted publicly on GitHub Container Registry here: https://github.com/users/pstark-code/packages/container/package/kubeview

- The `latest` tag is likely to be unstable   
- Versioned tags are build and pushed in sync with released versions of this repo, e.g. `docker pull ghcr.io/pstark-code/kubeview:0.1.17`


# Helm Chart
Helm chart called 'kubeview' is provided in the [charts](./charts) directory to help deploy and install KubeView into your cluster. The chart is also available in packaged form, [in the releases section](https://github.com/pstark-code/kubeview/releases)
...
## Change Log
[See releases](https://github.com/pstark-code/kubeview/releases)
